...
Route::post('backend/laporan/cetakuser', [UserController::class, 'cetakLaporanUser'])->name('backend.laporan.cetakuser')->middleware('auth');
...
Route::post('backend/laporan/cetakproduk', [ProdukController::class, 'cetakLaporanProduk'])->name('backend.laporan.cetakproduk')->middleware('auth');
